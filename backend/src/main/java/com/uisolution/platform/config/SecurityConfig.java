...
import com.uisolution.platform.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/git/**").hasAnyAuthority("SYSTEM_ADMIN", "SCREEN_ADMIN", "DEVELOPER")
                .requestMatchers("/admin/**").hasAnyAuthority("SYSTEM_ADMIN", "SCREEN_ADMIN")
                .requestMatchers("/schema/admin/**").hasAnyAuthority("SYSTEM_ADMIN", "SCREEN_ADMIN", "DEVELOPER")
                .requestMatchers("/datasource/**").hasAnyAuthority("SYSTEM_ADMIN")
                .requestMatchers("/schema/**").authenticated()
                .requestMatchers("/site/menus").authenticated()
